...
const FoodItemsPad = () => {
  ...
  useEffect(() => {
    axios.get("http://127.0.0.1:8000/api/Food%20items/")
      .then((response) => {
  ...
  return (
    <div className="container py-5">
      <h2 className="text-center mb-5 fw-bold">Food Items</h2>
      ...
      >
        ...
        {foodItems.slice(0, MAX_ITEMS).map((item) => (
          <div
            key={item.id}
            ...
            >
              <div>
                ...
                <p className="card-text text-muted mb-0">
                  <strong>Expires:</strong> {item.exp_date || "Unknown"}
                </p>
              </div>
